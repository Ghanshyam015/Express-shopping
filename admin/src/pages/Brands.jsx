...
const Brands = () => {
  ...
  const handleInputChange = (e) => {
    ...
    // If imageLink is changed, update preview
    if (name === "imageLink") {
  ...
  const handleSubmit = async (e) => {
    ...
    // Brand image is now optional (file or link)
    ...
    try {
      ...
      if (formData.image) {
        ...
        formDataToSend.append("imageLink", formData.imageLink.trim());
      }
  ...
  const openModal = (brand = null) => {
    if (brand) {
      ...
      setFormData({
        ...
        image: null,
        imageLink: brand.image && brand.image.startsWith("http") ? brand.image : "",
      });
          ...
          >
            <div className="bg-white rounded-lg max-w-md w-full max-h-[90vh] overflow-y-auto">
              ...
              <form onSubmit={handleSubmit} className="p-6 space-y-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">
                    Brand Logo (file or link, optional)
                  </label>
                  <input
                    type="file"
                    accept="image/*"
                    onChange={handleImageChange}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-black focus:border-transparent mb-2"
                  />
                  <input
                    type="url"
                    name="imageLink"
