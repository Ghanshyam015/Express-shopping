...
const config = {
  ...
  production: {
    ...
    CLIENT_BASE_URL:
      import.meta.env.VITE_CLIENT_BASE_URL || "https://Express Shopingclient.reactbd.com",
    ADMIN_BASE_URL:
      import.meta.env.VITE_ADMIN_BASE_URL || "https://Express Shopingadmin.reactbd.com",
    NODE_ENV: "production",
    DEBUG: false,
    LOG_LEVEL: "error",
  },
